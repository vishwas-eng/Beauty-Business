...
export const trackerRows: PerformanceRow[] = [
  ...
  // ── Fashion / Softlines (from SL BD Status Master Tracker) ──────────────────
  { brand: "US Polo", category: "Fashion - Footwear", segment: "Masstige", company: "PVH Corp", sourceCountry: "USA", launchMarket: "GCC", quadrant: "1A", status: "Commercials", workingDays: 45, progress: 90, nextStep: "Contract finalization", followUpStatus: "FOLLOW UP" },
  { brand: "Penti", category: "Fashion - Apparel", segment: "Masstige", company: "Penti", sourceCountry: "Turkey", launchMarket: "GCC", quadrant: "1A", status: "OD", workingDays: 60, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Campus", category: "Fashion - Footwear", segment: "Mass", company: "Campus Activewear", sourceCountry: "India", launchMarket: "GCC", quadrant: "4", status: "Commercials", workingDays: 38, progress: 90, nextStep: "Commercial terms review", followUpStatus: "FOLLOW UP" },
  { brand: "FC", category: "Fashion - Apparel", segment: "Masstige", company: "FC", sourceCountry: "Turkey", launchMarket: "GCC", quadrant: "2", status: "Commercials", workingDays: 30, progress: 90, nextStep: "Term sheet", followUpStatus: "FOLLOW UP" },
  { brand: "Puma", category: "Fashion - Footwear", segment: "Premium", company: "Puma SE", sourceCountry: "Germany", launchMarket: "GCC", quadrant: "1B", status: "Commercials", workingDays: 25, progress: 90, nextStep: "Pricing alignment", followUpStatus: "FOLLOW UP" },
  { brand: "Keds", category: "Fashion - Footwear", segment: "Masstige", company: "Wolverine", sourceCountry: "USA", launchMarket: "GCC", quadrant: "4", status: "Commercials", workingDays: 40, progress: 90, nextStep: "Final sign-off", followUpStatus: "FOLLOW UP" },
  { brand: "Keds", category: "Fashion - Footwear", segment: "Masstige", company: "Wolverine", sourceCountry: "USA", launchMarket: "India", quadrant: "4", status: "OD", workingDays: 55, progress: 95, nextStep: "Launch planning", followUpStatus: "ON TRACK" },
  { brand: "Keds", category: "Fashion - Footwear", segment: "Masstige", company: "Wolverine", sourceCountry: "USA", launchMarket: "SEA", quadrant: "1B", status: "OD", workingDays: 55, progress: 95, nextStep: "Launch planning", followUpStatus: "ON TRACK" },
  { brand: "Cardio Bunny", category: "Fashion - Apparel", segment: "Premium", company: "Cardio Bunny", sourceCountry: "Philippines", launchMarket: "GCC", quadrant: "3", status: "OD", workingDays: 50, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Cardio Bunny", category: "Fashion - Apparel", segment: "Premium", company: "Cardio Bunny", sourceCountry: "Philippines", launchMarket: "India", quadrant: "3", status: "OD", workingDays: 50, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Lyle & Scott", category: "Fashion - Apparel", segment: "Premium", company: "Lyle & Scott", sourceCountry: "UK", launchMarket: "India", quadrant: "4", status: "OD", workingDays: 48, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Lyle & Scott", category: "Fashion - Apparel", segment: "Premium", company: "Lyle & Scott", sourceCountry: "UK", launchMarket: "SEA", quadrant: "4", status: "OD", workingDays: 48, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Von Dutch", category: "Fashion - Apparel", segment: "Masstige", company: "Von Dutch", sourceCountry: "USA", launchMarket: "SEA", quadrant: "4", status: "OD", workingDays: 42, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Von Dutch", category: "Fashion - Apparel", segment: "Masstige", company: "Von Dutch", sourceCountry: "USA", launchMarket: "GCC", quadrant: "4", status: "OD", workingDays: 42, progress: 95, nextStep: "Onboarding", followUpStatus: "ON TRACK" },
  { brand: "Jack & Jones", category: "Fashion - Apparel", segment: "Masstige", company: "Bestseller", sourceCountry: "Denmark", launchMarket: "India", quadrant: "1A", status: "Leads", workingDays: 10, progress: 34, nextStep: "Qualify opportunity", followUpStatus: "FOLLOW UP" },
  { brand: "Next", category: "Fashion - Apparel", segment: "Masstige", company: "Next plc", sourceCountry: "UK", launchMarket: "SEA", quadrant: "1A", status: "SQL", workingDays: 22, progress: 72, nextStep: "Commercial proposal", followUpStatus: "FOLLOW UP" },
  { brand: "BHPC", category: "Fashion - Apparel", segment: "Premium", company: "PVH Corp", sourceCountry: "USA", launchMarket: "GCC", quadrant: "1A", status: "SQL", workingDays: 20, progress: 72, nextStep: "Commercial proposal", followUpStatus: "FOLLOW UP" },
  { brand: "BHPC", category: "Fashion - Apparel", segment: "Premium", company: "PVH Corp", sourceCountry: "USA", launchMarket: "India", quadrant: "1A", status: "SQL", workingDays: 20, progress: 72, nextStep: "Commercial proposal", followUpStatus: "FOLLOW UP" },
  { brand: "Wrangler Lee", category: "Fashion - Apparel", segment: "Masstige", company: "Kontoor Brands", sourceCountry: "USA", launchMarket: "SEA", quadrant: "1A", status: "MQL", workingDays: 14, progress: 56, nextStep: "Deck & intro call", followUpStatus: "FOLLOW UP" },
  { brand: "Adidas", category: "Fashion - Footwear", segment: "Premium", company: "Adidas AG", sourceCountry: "Germany", launchMarket: "GCC", quadrant: "1B", status: "Leads", workingDays: 8, progress: 34, nextStep: "Identify key contacts", followUpStatus: "FOLLOW UP" },
  { brand: "LCW", category: "Fashion - Apparel", segment: "Masstige", company: "LC Waikiki", sourceCountry: "Turkey", launchMarket: "SEA", quadrant: "1B", status: "SQL", workingDays: 18, progress: 72, nextStep: "Commercial review", followUpStatus: "FOLLOW UP" },
  { brand: "LCW", category: "Fashion - Apparel", segment: "Masstige", company: "LC Waikiki", sourceCountry: "Turkey", launchMarket: "India", quadrant: "1B", status: "SQL", workingDays: 18, progress: 72, nextStep: "Commercial review", followUpStatus: "FOLLOW UP" },
  { brand: "Aeropostale", category: "Fashion - Apparel", segment: "Masstige", company: "Authentic Brands", sourceCountry: "USA", launchMarket: "GCC", quadrant: "1B", status: "MQL", workingDays: 12, progress: 56, nextStep: "Intro deck", followUpStatus: "FOLLOW UP" },
  { brand: "love bonito", category: "Fashion - Apparel", segment: "Masstige", company: "Love Bonito", sourceCountry: "Singapore", launchMarket: "SEA", quadrant: "1A", status: "SQL", workingDays: 15, progress: 72, nextStep: "Commercial proposal", followUpStatus: "FOLLOW UP" },
  { brand: "US Polo", category: "Fashion - Footwear", segment: "Masstige", company: "PVH Corp", sourceCountry: "USA", launchMarket: "SEA", quadrant: "1B", status: "MQL", workingDays: 10, progress: 56, nextStep: "Intro call", followUpStatus: "FOLLOW UP" },
];
...
const trackerBrandProfiles: BrandProfile[] = [
  ...
  // ── Fashion / Softlines profiles ──────────────────────────────────────────
  {
    id: "brand-us-polo-fashion",
    brand: "US Polo",
    market: "GCC / SEA",
    stage: "Commercials / MQL",
    owner: "Vishwas Pandey",
    category: "Fashion - Footwear",
    summary: "GCC deal in active commercials at $595K confirmed Dec 2026 revenue. SEA qualification underway. Largest single fashion deal in the portfolio.",
    nextStep: "Finalize GCC contract terms. Run SEA intro call.",
    legalStatus: "Commercial terms active (GCC)",
    lastUpdate: "2026-04-06T12:00:00.000Z",
    keyContacts: [],
    documents: []
  },
  {
    id: "brand-puma-fashion",
    brand: "Puma",
    market: "GCC",
    stage: "Commercials",
    owner: "Vishwas Pandey",
    category: "Fashion - Footwear",
    summary: "Active commercial discussion in GCC. Forecast $51K confirmed revenue by Dec 2026. Premium footwear segment.",
    nextStep: "Align on final pricing and commercial structure.",
    legalStatus: "In negotiation",
    lastUpdate: "2026-04-05T12:00:00.000Z",
    keyContacts: [],
    documents: []
  },
  {
    id: "brand-keds-fashion",
    brand: "Keds",
    market: "GCC / India / SEA",
    stage: "Commercials / Signed",
    owner: "Vishwas Pandey",
    category: "Fashion - Footwear",
    summary: "Active across 3 markets. GCC in active commercials ($100K). India and SEA already signed ($126K combined). Strong cross-market footwear play.",
    nextStep: "Push GCC to sign-off. Begin India + SEA launch planning.",
    legalStatus: "Signed (India, SEA) · Active (GCC)",
    lastUpdate: "2026-04-05T12:00:00.000Z",
    keyContacts: [],
    documents: []
  },
  {
    id: "brand-cardio-bunny-fashion",
    brand: "Cardio Bunny",
    market: "GCC / India",
    stage: "Signed",
    owner: "Vishwas Pandey",
    category: "Fashion - Apparel",
    summary: "Signed deal across GCC ($51K) and India ($59K). Activewear/apparel. Onboarding in progress. Total confirmed $110K.",
    nextStep: "Complete onboarding process for both markets.",
    legalStatus: "Signed",
    lastUpdate: "2026-04-04T12:00:00.000Z",
    keyContacts: [],
    documents: []
  },
  {
    id: "brand-bhpc-fashion",
    brand: "BHPC",
    market: "GCC / India",
    stage: "SQL",
    owner: "Vishwas Pandey",
    category: "Fashion - Apparel",
    summary: "Beverly Hills Polo Club in SQL across GCC ($432K) and India ($137K). $569K combined pipeline. Premium apparel, strong brand recognition.",
    nextStep: "Send commercial proposal for both markets.",
    legalStatus: "Pre-NDA",
    lastUpdate: "2026-04-06T12:00:00.000Z",
    keyContacts: [],
    documents: []
  ...
  {
    id: "brand-next-fashion",
    brand: "Next",
    market: "SEA",
    stage: "SQL",
    owner: "Vishwas Pandey",
    category: "Fashion - Apparel",
    summary: "UK fashion retailer Next in SQL for SEA. $432K pipeline potential. Strong brand, broad assortment — good anchor for SEA fashion portfolio.",
    nextStep: "Issue commercial proposal and schedule review call.",
    legalStatus: "Pre-NDA",
    lastUpdate: "2026-04-05T12:00:00.000Z",
    keyContacts: [],
    documents: []
  ...
  {
    id: "brand-jack-and-jones-fashion",
    brand: "Jack & Jones",
    market: "India",
    stage: "Leads",
    owner: "Vishwas Pandey",
    category: "Fashion - Apparel",
    summary: "Bestseller-owned menswear brand. $567K India pipeline potential. Highest-value named deal in pipeline. Early lead stage — needs qualification.",
    nextStep: "Qualify opportunity and initiate first conversation.",
    legalStatus: "Not started",
    lastUpdate: "2026-04-04T12:00:00.000Z",
    keyContacts: [],
    documents: []
  ...
  {
    id: "brand-lcw-fashion",
    brand: "LCW",
    market: "SEA / India",
    stage: "SQL",
    owner: "Vishwas Pandey",
    category: "Fashion - Apparel",
    summary: "LC Waikiki — mass market Turkish fashion giant. $318K combined pipeline in SEA + India. High volume, strong value proposition.",
    nextStep: "Commercial review and proposal for both markets.",
    legalStatus: "Pre-NDA",
    lastUpdate: "2026-04-05T12:00:00.000Z",
    keyContacts: [],
    documents: []
